SELECT
	...
	MAX(
		CASE
			WHEN j.F01132 = 'AF 4.1 - Pagamento de Débitos Imóvel' THEN j.F01132
			ELSE NULL
		END) AS evento_AF_41,
	MAX(
		CASE
			WHEN j.F01132 = 'AF 4.1 - Pagamento de Débitos Imóvel' THEN a.F00385
			ELSE NULL
		END) AS data_AF_41,
	MAX(
		CASE
			WHEN j.F01132 = 'AF 4.1 - Pagamento de Débitos Imóvel' THEN b.F00689
			ELSE NULL
		END) AS advoado_AF_41,
	MAX(
		CASE
