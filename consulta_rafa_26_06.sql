SELECT
	...
	MAX(CASE WHEN c.F01132 = 'AF 13.1 - Solicitação de HO' THEN a.F00385 ELSE NULL END) AS 'AF_131',
...
HAVING
	...
	MAX(g.F43686) = 'AF 12 - Liminar em Ação Contra' AND
	MAX(CASE WHEN c.F01132 = 'AF 13.1 - Solicitação de HO' THEN a.F00385 ELSE NULL END) IS NULL AND
	MAX(CASE
		WHEN f.F25017 = 1 THEN 'Ativo'
		WHEN f.F25017 = 2 THEN 'Encerrado'
		WHEN f.F25017 = 3 THEN 'Acordo'
