SELECT
	...
	MAX(p.F00074) UF,
	MAX(CASE WHEN c.F01132 LIKE 'DP%' THEN c.F01132 end) AS evento_dp,
	CAST(MAX(CASE WHEN c.F01132 LIKE 'DP%' THEN a.F00385 end) AS DATE) AS data_dp
...
HAVING
    MAX(CASE WHEN c.F01132 LIKE 'DP%' THEN c.F01132 END) IS NOT NULL
    AND MAX(f.F25017) <> 2
